...
const REVIEWS = [
  ...
  },
  {
    name: "클라우드 인프라",
    score: 5.0,
    text: "훈련에서 만난 직원분들, 학우분들, 강사님 그리고 멘토님과의 만남은 정말 특별하고 소중했습니다. 특히 강사님의 수업과 학생들에 쏟는 열정과 노력에 언제나 감사하고 고맙습니다. 강사님 덕분에 많은 것을 배우며, 제가 가고자 하는 분야에 자신감을 가지고 잘 헤쳐나갈 수 있을꺼라고 생각합니다. 그리고 멘토님에게 정말 감사합니다. 실무적으로 많은 부분을 배우고 놓쳤던 기초적인 CS와 선배로써의 취업 상담은 돈주고도 얻을 수 없었던 값진 것이라고 생각합니다. 정말 감사합니다!",
    date: "2025.10.02"
  }
];
